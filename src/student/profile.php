...
<input  class="btn btn-primary mt-3" type="submit" name="submit_pass" value="Submit"/>
 ...
 if(isset($_POST["submit_pass"])){?>
   ...
   if($old2==$pass1)
   {
     if($pass2==$pass3)
     {
       $sql = "UPDATE `student` SET `password`='$pass2' WHERE username ='$user';";
